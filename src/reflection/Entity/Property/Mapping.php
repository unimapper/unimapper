...
class Mapping
{
        ...
        foreach (explode(";", $definition) as $parameter) {
            ...
            switch (strtolower($name)) {
                ...
                case "filter":
                    ...
                    $this->filterIn = $this->createCallable($in);
                    $this->filterOut = $this->createCallable($out);
                    break;
                default:
    ...
    private function createCallable($definition)
    {
        ...
        throw new PropertyException(
            "Invalid mapping definition. Filter must contain valid callbacks or entity function name but '" . $definition . "' given!",
